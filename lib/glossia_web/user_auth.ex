defmodule GlossiaWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule GlossiaWeb.PageLive do
        use GlossiaWeb, :live_view

        on_mount {GlossiaWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{GlossiaWeb.UserAuth, :ensure_authenticated}] do
