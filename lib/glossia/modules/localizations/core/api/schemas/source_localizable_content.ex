defmodule Glossia.Modules.Localizations.Core.API.Schemas.SourceLocalizableContent do
  # Modules
  require OpenApiSpex
  alias OpenApiSpex.Schema
  alias Glossia.Modules.Localizations.Core.API.Schemas.SourceContext
