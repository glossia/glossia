...
`L10N.md` reference site, deployment manifests, and supporting product documentation.
...
for a specific language belong in `L10N/<locale>.md`.

## Product Language

- Keep "Glossia" untranslated.
- Keep `L10N.md`, `.glossia/`, command names, file paths, environment variable names, and
