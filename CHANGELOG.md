...
### Features
- feat: rewrite `glossia init` with Agent Client Protocol (ACP)
...
Simplify the workflow example to use Glossia directly via mise, and explain
...
Rewrites the entire Glossia CLI in Rust for better performance, smaller
...
- Merge pull request #11 from internal/claude/consistent-cli-output
...
### Other
- Merge pull request #9 from internal/claude/add-experimental-warning-5CB8Q

## [v0.11.0] - 2026-02-03

### Features
- feat: update blog post with install instructions and product closing

- Fix Maria Jose's GitHub handle to @mjsesalm
- Add "Get started" section with CLI install and setup instructions
- Replace closing with message about Glossia being polished and product-ready

https://claude.ai/code/session_01NodfLj4Tzcfw6zhssP8nky


### Other
- Merge pull request #8 from internal/claude/add-blog-setup-instructions-fBn0o
...
The first post covers why Glossia was built — the overhead of syncing content
...
### Other
- Merge pull request #7 from internal/claude/add-localization-blog-post-prJrQ
...
### Other
- Merge pull request #6 from internal/claude/add-translation-improvement-section-zgqqI
...
### Other
- Merge pull request #5 from internal/claude/fix-mobile-responsive-Y0HcQ
...
### Other
- Merge pull request #4 from internal/claude/fix-mobile-snippet-margin-KEY2k
...
### Other
- Merge pull request #2 from internal/claude/cli-bun-reimplementation-xzq8x
...
### Other
- Merge pull request #3 from internal/claude/fix-code-snippet-overflow-Re9Jo
...
### Other
- Merge pull request #1 from internal/claude/make-website-responsive-As32c
...
- Add Glossia tool to mise config
...
### Other
- Build Glossia CLI, site, and Anthropic support
