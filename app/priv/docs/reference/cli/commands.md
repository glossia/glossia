...
Create a starter `L10N.md` configuration file in the current repository.
...
Glossia plans the work from your `L10N.md` files, translates each file with
...
The model is chosen per document: a `L10N.md` `model:` naming one of your
