...
The key insight is that context accumulates. Every review comment that leads to an updated `L10N.md` or a corrected glossary entry improves all future runs, not just the file that triggered the review.
