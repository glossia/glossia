...
The key insight is that context accumulates. Every review comment that leads to an updated `GLOSSIA.md` or a corrected terminology entry improves all future runs, not just the file that triggered the review.
