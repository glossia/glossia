%{
  ...
  summary: "Traditional localization tools add overhead, break CI, and lock you into vendor ecosystems. Together with María José, we're exploring what an agentic localization workflow can look like.",
  date: ~D[2026-02-03],
...
But the terminal is just the first interface, not the only one. We know that not everyone who contributes to localization quality is a developer. María José and I talk about this often. The people who care most about translation accuracy, tone, and cultural nuance are often linguists and content specialists who don't think in terms of branches, compilation, or JSON.
