defmodule Glossia.Projects.SetupHarness do
  ...
  def build_prompt(target_languages) do
    ...
    [
      ...
      "- This product currently uses L10N.md as the canonical Glossia configuration and context file.",
      "- If the repository already has L10N.md or scoped L10N.md files, update them.",
      "- If neither exists, create a root L10N.md.",
      ...
      "    - es",
      "  ---",
      "- Root L10N.md must declare source_language when the repository does not already do so.",
      "- Declare sources as a mapping of source globs to translated output templates.",
      "- Declare targets as the selected locale codes.",
      "- Scoped files use the same L10N.md filename inside subdirectories.",
      "- Locale-specific context belongs in L10N/<locale>.md.",
      ...
      "- Use output templates with {locale}, {relpath}, {basename}, and {ext} for translated paths when L10N.md is used.",
