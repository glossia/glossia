defmodule Glossia.Ingestion.Buffer do
  @moduledoc """
  GenServer-based buffer for batching ClickHouse inserts.

  Accumulates RowBinary-encoded rows and flushes them to ClickHouse either
  when the buffer reaches `max_buffer_size` bytes or after `flush_interval_ms`
  ...
  defp default_flush_interval_ms do
    Keyword.fetch!(Application.get_env(:glossia, IngestRepo), :flush_interval_ms)
  end
