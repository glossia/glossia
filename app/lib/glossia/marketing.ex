defmodule Glossia.Marketing do
  @moduledoc false
  ...
  defmodule Empty do
    ...
    def blog_post_by_slug!(slug) do
      raise Glossia.Marketing.NotFoundError, "blog post with slug=#{slug} not found"
    end
    ...
    def feature_page_by_slug!(slug) do
      raise Glossia.Marketing.NotFoundError, "feature page with slug=#{slug} not found"
    end
    ...
    def docs_subcategory!(category, key) do
      raise Glossia.Marketing.NotFoundError, "subcategory #{category}/#{key} not found"
    end
    ...
    def doc_page!(category, slug) do
      raise Glossia.Marketing.NotFoundError,
...
defmodule Glossia.Marketing.NotFoundError do
