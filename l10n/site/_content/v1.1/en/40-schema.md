...
kind: section
number: "4"
title: Document Schema, Version 1.1
---

The version 1.1 contract is defined by the JSON Schema files in
<code>schemas/v1.1/</code>.
...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/glossia-document.schema.json"><code>schemas/v1.1/glossia-document.schema.json</code></a></p>

### 4.2 Global Document Schema {:#schema-global:}

The repository root <code>GLOSSIA.md</code>. Translation fields are optional; including them lets a single-file repository describe its language, preferred model, and translation workflow in one place.
...
<tr><td><code>model</code></td><td>no</td><td>string</td><td>a model identifier (<a href="#schema-shared">Section 4.5</a>)</td></tr>
...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/global-document.schema.json"><code>schemas/v1.1/global-document.schema.json</code></a></p>

### 4.3 Scoped Document Schema {:#schema-scoped:}

A non-root <code>GLOSSIA.md</code>. Translation fields are optional; when omitted, the document acts as a context override for its subtree.
...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/scoped-document.schema.json"><code>schemas/v1.1/scoped-document.schema.json</code></a></p>
...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/locale-overlay.schema.json"><code>schemas/v1.1/locale-overlay.schema.json</code></a></p>
...
<tr><td><code>modelIdentifier</code></td><td>string</td><td>a non-empty string naming a model by its Model ID in [MODELS-DEV]; schema validation only checks that it is non-empty because the external catalog changes over time. Example: <code>openai/gpt-5</code>.</td></tr>
...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/shared.schema.json"><code>schemas/v1.1/shared.schema.json</code></a></p>
