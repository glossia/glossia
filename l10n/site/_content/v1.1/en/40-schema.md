...
<p class="schema-source">Canonical schema: <a href="/schemas/v1.1/l10n-document.schema.json"><code>schemas/v1.1/l10n-document.schema.json</code></a></p>

### 4.2 Global Document Schema {:#schema-global:}

The repository root <code>L10N.md</code>. Translation fields are optional; including them lets a single-file repository describe its language, preferred model, and translation workflow in one place.
...
A non-root <code>L10N.md</code>. Translation fields are optional; when omitted, the document acts as a context override for its subtree.
