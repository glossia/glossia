...
<dd>A non-empty string naming a translation model by its Model ID in [MODELS-DEV]. See <a href="#schema-shared">Section 4.5</a>. Example: <code>openai/gpt-5</code>.</dd>
