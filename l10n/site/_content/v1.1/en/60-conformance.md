...
patterns in [Section 3](#model) and that validates against the version 1.1 entry
schema ([Section 4.1](#schema-entry)).

A *conforming repository* <span class="kw">MUST</span> contain at most one root
document, located at <code>GLOSSIA.md</code>, and every file whose path matches a document
