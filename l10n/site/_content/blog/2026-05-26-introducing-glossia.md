...
GLOSSIA.md is a simple convention that answers these questions before translation
starts. It works like this: you add a `GLOSSIA.md` file to your repository with
...
A root `GLOSSIA.md` carries repository-wide guidance. Scoped `GLOSSIA.md` files
nested in directories override settings for specific subtrees. And locale
overlays in `GLOSSIA/<locale>.md` provide per-language nuance.
...
We're using GLOSSIA.md to dogfood the convention -- this specification site is
